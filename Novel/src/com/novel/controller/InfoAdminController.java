...
public class InfoAdminController {
	...
	@AuthPassport
	@RequestMapping(value="/searchdiagram", produces="application/json", method=RequestMethod.GET)
	@ResponseBody
	...
	@ResponseBody
	public Map<String, Object> pvdata(HttpServletRequest request, HttpServletResponse response, String date) throws Exception {
		Map<String, Object> modelMap = new HashMap<String, Object>();
